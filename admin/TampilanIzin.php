      ...
      <?php
        ...
        while ($data = mysqli_fetch_array($hasil) ){
          echo "<tr>
              ...
              <td>".$data['Kelas']."</td>
              <td> <a href =prosesSakit.php?username=".$data['username']." class='btn btn-danger btn-sm'> Sakit </a> </td>
              <td> <a href =prosesIzin.php?username=".$data['username']." class='btn btn-success btn-sm'> Izin </a> </td>
            </tr>"; $n++;
        }  ;
      ?>
</div>
